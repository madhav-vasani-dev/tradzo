...
export class BrokerCallbackComponent implements OnInit {
  ...
  private parseError(code: string): string {
    const map: Record<string, string> = {
      ...
      'token_exchange_failed': 'The broker rejected the request. Check that your API key/secret are correct and that your app\'s Redirect URI is exactly https://tradzo-backend.duckdns.org/broker/upstox/callback.',
